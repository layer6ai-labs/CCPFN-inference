...
from ....benchmarks.base import EvalDatasetCatalog, GeneralizedADMITDataset, CEPO_Dataset, DRC_Dataset
...
class ADMITDataset(GeneralizedADMITDataset, EvalDatasetCatalog):
    def __init__(
        ...
        **kwargs
        ...
        """
        Synthetic datasets based on that generated in the paper "Generalizing Bounds
        for Estimating Causal Effects of Continuous Treatments".
        """
        GeneralizedADMITDataset.__init__(self, *args, **kwargs)
        EvalDatasetCatalog.__init__(self, n_tables=n_tables, name="ADMIT")
